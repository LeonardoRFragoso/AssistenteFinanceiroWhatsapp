...
def upgrade() -> None:
    ...
    if is_pg:
        ...
        charge_status_type = postgresql.ENUM('pending', 'paid', 'expired', 'cancelled', 'failed', name='chargestatus', create_type=False)
        pending_status_type = postgresql.ENUM('pending', 'confirmed', 'cancelled', 'expired', 'executed', 'failed', name='pendingactionstatus', create_type=False)
    else:
        charge_status_type = sa.String(20)
        pending_status_type = sa.String(20)
    ...
    op.create_table(
        ...
        sa.Column('status', charge_status_type, nullable=False, server_default='pending'),
    ...
    op.create_table(
        ...
        sa.Column('status', pending_status_type, nullable=False, server_default='pending'),
