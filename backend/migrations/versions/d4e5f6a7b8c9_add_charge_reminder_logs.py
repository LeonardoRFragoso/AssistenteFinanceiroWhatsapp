...
def upgrade() -> None:
    ...
    if is_pg:
        ...
        reminder_type_col = postgresql.ENUM('due_soon', 'overdue', name='remindertype', create_type=False)
    else:
        reminder_type_col = sa.String(20)
    ...
    op.create_table(
        ...
        sa.Column('reminder_type', reminder_type_col, nullable=False),
